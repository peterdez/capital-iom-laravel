<div class="header">
<nav class="navbar navbar-expand-lg fixed-top bg-body-tertiary py-3">
  <div class="container">
    <a class="navbar-brand" href="#"><img src = "{{asset('assets/img/capital-iom_logo.svg')}}" class="w-75" alt="My Happy SVG"/></a>
